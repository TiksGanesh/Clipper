...
export default function BookingForm({ shop, barbers, services }: Props) {
    ...
    const handlePaymentAndBooking = async (e: React.FormEvent) => {
        ...
        if (!barberId) return setErrorMessage(`Please select a ${terms.staff_label.toLowerCase()}`)
        if (serviceIds.length === 0) return setErrorMessage(`Please select a ${terms.service_label.toLowerCase()}`)
                            ...
                            {barbers.slice(0, 2).map((b) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex-shrink-0 px-5 py-3 rounded-xl border font-medium transition-all ${selected
                            ...
                            {services.map((s) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`relative flex items-center p-4 rounded-xl border cursor-pointer transition-all ${selected
                                    ...
                                    >
                                        ...
                                        <div className={`w-5 h-5 rounded-full border flex items-center justify-center transition-colors ${selected ? 'bg-indigo-600 border-indigo-600' : 'border-gray-300 bg-white'
                                            }`}>
                                ...
                                {dateOptions.map((option) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex-1 px-4 py-3 rounded-xl border-2 font-medium transition-all ${isSelected
                                                ...
                                                {[
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            disabled={isDisabled}
                                                            className={`px-4 py-2.5 font-medium text-sm transition-all relative ${isDisabled
                                                            ...
                                                            {groupedSlots.morning.map((slot) => {
                                                                ...
                                                                return (
                                                                    <button
                                                                        ...
                                                                        className={`px-2 py-2.5 rounded-lg text-sm font-medium transition-all ${sel
                        ...
                        <div className="grid gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    minLength={1}
                                    className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-colors ${nameError ? 'border-red-300 bg-red-50/50' : 'border-gray-200'
                                        }`}
                                    value={customerName}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-16 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none font-medium tracking-wide transition-colors ${phoneError ? 'border-red-300 bg-red-50/50' : 'border-gray-200'
                                            }`}
                                        value={customerPhone}
